    ...
    {user && <div className='flex items-center gap-2' >
     {
      ...
      <button onClick={toggleGpt}  className='bg-blue-600 rounded px-4 p-1 text-white' >{toggle?"Homepage":"Gpt Search"}</button>
      <Link to={"/search"} ><button onClick={toggleSearch}  className='bg-blue-600 rounded px-4 p-1 text-white' >{toggle2?"Homepage":"Movie Search"}</button></Link>
